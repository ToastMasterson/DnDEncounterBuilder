...
function postLogIn(){
    fetch("http://localhost:3000/masters/log_in", {
        method: "POST",
        headers: {
...
function postToGetEncounters(id){
    fetch("http://localhost:3000/encounters/get_monsters", {
        method: "POST",
        headers: {
            "Content-Type":"application/json",
            "Accept":"application/json"
...
function removeMonster(encounterId, monsterId, cardToRemove){
    fetch("http://localhost:3000/encounters/remove_monster", {
        method: "POST",
        headers: {
            "Content-Type":"application/json",
            "Accept":"application/json"
